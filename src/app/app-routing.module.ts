...
const routes: Routes = [
  ...
  { path: 'pago/:dni/:carextr/:fecha/:name', component: PagoComponent},
  // { path: 'pago', component: PagoComponent},
  // { path: 'boleta', component: BoletaComponent},
  { path: 'boleta/:dni/:carextr/:fecha/:name', component: BoletaComponent},
  ...
  { path: 'validacioncliente', component: ValidarusuarioComponent},
